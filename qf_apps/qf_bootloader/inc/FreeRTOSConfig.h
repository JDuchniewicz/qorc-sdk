...
/* only do this check for C code not ASM code */
...
#define configUSE_MALLOC_FAILED_HOOK	1	// for debugging heap problem
#define configUSE_APPLICATION_TASK_TAG	        0
#define configNUM_THREAD_LOCAL_STORAGE_POINTERS 3
#define configUSE_COUNTING_SEMAPHORES	        1
#define configGENERATE_RUN_TIME_STATS	        0       //YWU modify
...
//#define configSAVE_TASK_HISTORY		1
...
#define configTIMER_TASK_PRIORITY		(20) //Highest task priority similar to PM Task //( 2 )
...
//#define configASSERT( x ) if( ( x ) == 0 ) { extern void go_to_ramdump_mode(void); 	go_to_ramdump_mode(); }
